...
// export const triviaResp = new Modules('module?populate[Trivia][populate][TriviaItem][populate]=*')
export const triviaResp = new Modules('module?populate[trivia][populate]=*')
